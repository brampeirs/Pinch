-- ============================================
-- UPDATE RPC: create_recipe with section support
-- ============================================
-- Adds section_name support for ingredients and steps
...
BEGIN
  ...
  -- Insert ingredients with section_name
  FOR v_ingredient IN SELECT * FROM jsonb_array_elements(ingredients_data)
  LOOP
    -- Normalize section_name: trim whitespace, null if empty
  ...
  -- Insert steps with section_name
